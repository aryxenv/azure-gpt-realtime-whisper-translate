...
```env
AZURE_OPENAI_REALTIME_COMMIT_INTERVAL_MS=2500
AZURE_OPENAI_REALTIME_MIN_COMMIT_AUDIO_MS=1000
AZURE_OPENAI_REALTIME_MIN_AUDIO_RMS=0.005
AZURE_OPENAI_REALTIME_STOP_DRAIN_MS=2000
```
